...
import static com.gunaeats.myecommerce.FragmentUtills.CartFragment.updateTotal;
...
public class CartItemadapter extends RecyclerView.Adapter<CartItemadapter.MyViewHolder> {
    ...
    Mycart mycart;
    public CartItemadapter( Context mContext, List<LocalCartModal> cartList, int type) {
    ...
    @Override
    public CartItemadapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i)
    {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.single_item_cart, null);
        CartItemadapter.MyViewHolder viewHolder = new CartItemadapter.MyViewHolder(view);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull CartItemadapter.MyViewHolder holder, final int i) {
